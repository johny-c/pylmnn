...
def main(autotune=True, load=0):
    ...
    news_train = skd.fetch_20newsgroups(subset='train', remove=('headers', 'footers', 'quotes'))
    news_test  = skd.fetch_20newsgroups(subset='test', remove=('headers', 'footers', 'quotes'))

    X = news_train.data + news_test.data
